...
export function CustomTextArea(props) {
    ...
    return (_jsx(CustomFormControl, Object.assign({ py: 1 }, formControlProps, { label: label, error: error === null || error === void 0 ? void 0 : error.join(", "), labelProps: Object.assign(Object.assign({}, formControlProps === null || formControlProps === void 0 ? void 0 : formControlProps.labelProps), { htmlFor: ((_a = formControlProps === null || formControlProps === void 0 ? void 0 : formControlProps.labelProps) === null || _a === void 0 ? void 0 : _a.htmlFor) || props.id || props.name }) }, { children: _jsx(Textarea, Object.assign({ fontSize: "sm", name: name, defaultValue: value }, restOfProps)) })));
}
